def Read_Patients_DataBase():
    myfile = open("Patients_DataBase.json", "r")
    ...
    for i in text:
        if flag == 0:
            ...
            if i != "\n":
                ...
                Patients_Dict[int(Patient_ID)] = [Department, Doctor_Name, Patient_Name, Patient_Age, Patient_Gender,
                                                  Patient_Address, RoomNumber]
                Patient_ID = ""
                Department = ""
                Doctor_Name = ""
                Patient_Name = ""
...
def Read_Doctors_DataBase():
    myfile = open("Doctors_DataBase.json", "r")
    Doctors_Dict = dict()
    Doctor_ID = ""
    Department = ""
    Doctor_Name = ""
